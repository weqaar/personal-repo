...
/************************************ Process 2 (Low Priority) **********************************/
	...
	if(prio_inheritance == 0)
	{
		setpriority(PRIO_PROCESS,PID_L,PRIO_L); 
		printf("The Priority of LOW Process %d changes = %d\n", PID_L,PRIO_L);
	}	
	if(prio_inheritance == 1)
	{
		setpriority(PRIO_PROCESS,PID_L,PRIO_H); 
		printf("The Priority of LOW Process %d changes = %d ---> High\n", PID_L,PRIO_H);
		printf("Priority is inherited. . . \n");
	}
